...
function StatutesPopUp({ formData, handleChange, handleSubmit, handleClosePopup }) {
  ...
  return (
    <div className="popup-overlay">
      <div className="popup">
        ...
        <h2>Add a New Statutes / დაამატე ახალი წესდება</h2> 
        ...
        <div>
          ...
          <button type="submit" className='addPop-but' disabled={loading}>
              {loading ? 'Uploading...' : 'Add a Statute'}
          </button>
        </form>
      </div>
    </div>
